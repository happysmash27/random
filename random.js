...
function makeIframe(x,y,width,height,innerwidth, innerheight, src){
    ...
    canvas2.setAttribute("viewBox", "-60 -70 " + (innerwidth+90) + " " + (innerheight+80))
    canvas2.setAttribute("width",width+6)
    canvas2.setAttribute("height",height+7)
    canvas2.setAttribute("x",x-3)
    canvas2.setAttribute("y",y-4)
